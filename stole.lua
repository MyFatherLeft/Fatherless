...
if game.CoreGui:FindFirstChild("MyFatherLeftMe") then
    game.CoreGui.MyFatherLeftMe:Destroy()
end
game:GetService("UserInputService").InputBegan:connect(
    function(key, gpe)
        if key.KeyCode == Enum.KeyCode.RightControl then
            game.CoreGui.MyFatherLeftMe.Enabled = not game.CoreGui.MyFatherLeftMe.Enabled
        end
    end
)
...
local PhantomLib = Instance.new("ScreenGui")
PhantomLib.Name = "MyFatherLeftMe"
if syn and syn.protect_gui then
    syn.protect_gui(PhantomLib)
    PhantomLib.Parent = game.CoreGui
elseif gethui then
    PhantomLib.Parent = gethui()
else
    PhantomLib.Parent = game.CoreGui
end
PhantomLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
